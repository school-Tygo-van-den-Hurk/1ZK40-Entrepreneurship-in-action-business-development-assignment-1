\section{Market Opportunities: Abandoned Mine Shafts}
    ...
    \subsection{Market Opportunity Description}
        ...
        This opportunity is supported by trends including the growing need for long-duration energy storage, the abundance of abandoned mine shafts and incentives for energy storage that isn't bad for the envoirment.  
    ...
    \subsection{Attractiveness Assessment (MON Worksheet 2)}
        ...
        \subsubsection{Potential}
            ...
            \paragraph{Market Volume — Mid}  
                ...
                Tens of thousands of abandoned shafts are available globally (for example 550,000 in the USA\cite{amount-of-mineshafts}), but only a fraction are suitable for GBES due to location, depth, or condition.  
    ...
    \subsection{Challenges and Mitigation}
        ...
        While promising, using abandoned mineshafts for GBES does face a couple challenges:
...
\begin{thebibliography}{9}
    \bibitem{Hunt2023} B.~Zakeri \textit{et al.}, “Underground Gravity Energy Storage: A Solution for Long-Term Energy Storage,” IIASA News Release, Jan. 2023.
    \bibitem{RTBC2024} “Abandoned Coal Mines are Becoming the Batteries of the Future,” \textit{Reasons to be Cheerful}, 2024.
\end{thebibliography}